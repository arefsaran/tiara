    ...
    return this.each(function () {
      ...
      function _advanceInputGroup(parentelement) {
        ...
        var downhtml,
          uphtml,
          prefixhtml =
            '<div class="input-group-prepend"><span class="input-group-text bootstrap-touchspin-prefix">' +
            settings.prefix +
            "</span></div>",
          postfixhtml =
            '<div class="input-group-append"><span class="input-group-text bootstrap-touchspin-postfix">' +
            settings.postfix +
            "</span></div>";
        ...
        if (next.hasClass("input-group-btn")) {
          ...
          uphtml =
            '<div class="input-group-append ml-0"><button class="' +
            settings.buttonup_class +
            ' bootstrap-touchspin-up" type="button">' +
            settings.buttonup_txt +
            "</button></div>";
      ...
      function _buildInputGroup() {
        ...
        if (settings.verticalbuttons) {
          ...
          html =
            ...
            settings.prefix +
            '</span></div><div class="input-group-append"><span class="input-group-text bootstrap-touchspin-postfix">' +
            settings.postfix +
            '</span><button class="' +
            settings.buttonup_class +
            ' bootstrap-touchspin-up" type="button">' +
