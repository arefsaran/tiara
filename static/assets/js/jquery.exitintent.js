...
!(function (e) {
  ...
  (e.initNamespaceStorage = function (e) {
    ...
    g
      ? ((e.localStorage = e.extend({}, l, { _type: "localStorage" })),
        (e.sessionStorage = e.extend({}, l, { _type: "sessionStorage" })))
      : ((e.localStorage = e.extend({}, l, { _type: "localCookieStorage" })),
...
(function (a) {
  function d(e) {
    0 < e.clientY ||
      (b && clearTimeout(b),
      0 >= a.exitIntent.settings.sensitivity
  ...
  a.exitIntent = function (b, f) {
    ...
    if ("enable" == b) a(window).mouseleave(d), a(window).mouseenter(c);
      ...
      c(), a(window).unbind("mouseleave", d), a(window).unbind("mouseenter", c);
    else
      throw "Invalid parameter to jQuery.exitIntent -- should be 'enable'/'disable'";
  };
